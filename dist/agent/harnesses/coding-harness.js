...
export class CodingHarness extends BaseHarness {
    id = "coding";
    description = "Coding-focused agent for implementation, debugging, refactoring, and testing. No financial or social tools.";
    buildSystemPrompt() {
        ...
        return [
            {
                ...
                execute: async (args) => {
                    ...
                    const timeoutMs = Math.min(typeof args.timeout_ms === "number" ? args.timeout_ms : 30_000, MAX_EXEC_TIMEOUT_MS);
...
//# sourceMappingURL=coding-harness.js.map