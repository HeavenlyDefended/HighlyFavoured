 ...
 */
export async function getUsdcBalance(address, network = "eip155:8453", chainType) {
 ...
 */
export async function x402Fetch(url, account, method = "GET", body, headers, maxPaymentCents, chainType) {
