 ...
 */
async function enrichAgentWithCard(agent, cfg, db) {
    try {
 ...
 */
export async function discoverAgents(limit = 20, network = "mainnet", config, db, rpcUrl) {
 ...
 */
export async function searchAgents(keyword, limit = 10, network = "mainnet", config, db, rpcUrl) {
