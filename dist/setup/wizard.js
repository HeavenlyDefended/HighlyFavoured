...
export async function runSetupWizard() {
    ...
    try {
        ...
        if (manual) {
            ...
            fs.writeFileSync(path.join(configDir, "config.json"), JSON.stringify({ apiKey, walletAddress: walletAddress, provisionedAt: new Date().toISOString() }, null, 2), { mode: 0o600 });
...
function showFundingPanel(address, chainType = "evm") {
